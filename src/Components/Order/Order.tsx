...
//   { name: "Красный", css: "#e65206" },
//   { name: "Белый", css: "#ffffff" }
// ];

// const TELEGRAM_USERNAME = "tentoteka"; // /t/tentoteka
...
//     // Accept +7XXXXXXXXXX or +7XXXXXXXXXXX? we'll accept +7 + 10 digits
...
//     // Открываем в новой вкладке (проверка popup-блокировки)
//     const newWindow = window.open(url, "_blank");
//     if (!newWindow) {
//       // fallback: перенаправление самой страницы
//       window.location.href = url;
//     }
//   };

//   // when user changes type, reset downstream selections:
...
//         <p className={styles.subtitle}>Выберите тип транспорта и оформите заказ в Telegram за 1 минуту</p>
//       </div>
...
//                 <div className={styles.typeLabel}>Авто</div>
...
//               >
//                 <div className={styles.typeIcon}>🛻</div>
//                 <div className={styles.typeLabel}>Прицеп</div>
//                 <div className={styles.typeHint}>Различные прицепы и трейлеры</div>
//               </button>
//             </div>
...
//               placeholder="Укажите дополнительные пожелания (цвет каркаса, сроки, монтаж и т.п.)"
//               value={comment}
...
//             <div className={styles.controlsRow}>
//               <button className={styles.backBtn} onClick={goBack}>Назад</button>
//               <button className={styles.orderBtn} onClick={onSubmit}>Заказать в Telegram</button>
//             </div>

//             <p className={styles.micro}>Откроется Telegram — вы сможете проверить сообщение и отправить его.</p>
//           </div>
//         )}
//       </div>
